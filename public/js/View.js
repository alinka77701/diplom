...
View.prototype.showDialogOrganisation = function (organisation) {
  ...
  document.getElementById(
      "infoCompany").innerHTML = organisation.info_organisation;
  document.getElementById(
      "phoneOrg").innerHTML = organisation.phone_organisation;
  document.getElementById(
      "emailOrg").innerHTML = organisation.email_organisation;
  document.getElementById(
      "addressOrg").innerHTML = organisation.address_organisation;
  document.getElementById(
      "placesCompany").innerHTML = organisation.max_students_number;
  document.getElementById(
      "loginCompany").innerHTML = organisation.login_organisation;
  document.getElementById(
      "pswdCompany").innerHTML = organisation.pswd_organisation;
