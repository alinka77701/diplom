...
Controller.prototype.init = async function () {
    ...
    this.View.onClickShowDialogGenerateDocument = this.generateDocument.bind(this);
    this.View.init();
